...
```javascript
asinh = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast-asinh@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast-asinh@umd/bundle.js"></script>
```
